...
1. **Gather context** — read the workspace files (use Glob to list, Read on the relevant ones). Read any prior failure log at `WORKSPACE/.claude-forge/floor-<N>-history.json`.
